for i = 8, 40, 2 do
    surface.CreateFont("MuroSkins" .. i,
    {
        font     = "Arimo",
        weight   = 500,
        size     = i,
...
--[[--------------------------------
		BY MURO
        STEAM: https://steamcommunity.com/id/TimeMuro/
		VK: https://vk.com/timemuro
----------------------------------]]

print("Q menu Skin Load")
...
SKIN.PrintName		= "Muro Skin"
SKIN.Author			= "Muro"
SKIN.DermaVersion	= 1
SKIN.GwenTexture	= Material( "muroskin/muroskin.png" )
...
SKIN.fontCategoryHeader			= "MuroSkins"
...
derma.DefineSkin( "muroskin", "Muro Purple Skin", SKIN )
