...
for i = 8, 40, 2 do
    surface.CreateFont("DarkPurple" .. i,
    {
        font     = "Arimo",
        weight   = 500,
        size     = i,
...
print("╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╭━╯┃╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╭━╯┃")
print("╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╰━━╯╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╰━━╯")]]
print("Derma Skin by derurmeltom")
print("")
...
SKIN.PrintName		= "Dark Purple Derma Skin by EGC"
SKIN.Author			= "derurmeltom"
SKIN.DermaVersion	= 1
SKIN.GwenTexture	= Material( "gwenskin/darkpurple.png" )
...
SKIN.fontFrame					= "DarkPurple"

SKIN.control_color				= Color( 206, 66, 245, 255 )
SKIN.control_color_highlight	= Color( 206, 66, 245, 255 )
SKIN.control_color_active		= Color( 206, 66, 245, 255 )
SKIN.control_color_bright		= Color( 206, 66, 245, 255 )
SKIN.control_color_dark			= Color( 206, 66, 245, 255 )
...
SKIN.fontCategoryHeader			= "DarkPurple"
